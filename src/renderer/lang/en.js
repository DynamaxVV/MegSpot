export default {
  ...
  dashboard: {
    compareTask: {
      ...
      table: {
        title: 'Pair Preview',
        matchInOrder: 'Match in order',
        matchInOrderShort: 'In order',
        matchInOrderPopoverTitle: 'Group Pairing Rules',
        matchInOrderSingleTitle: 'Folder Pairing Rules',
        enabled: 'Enabled',
        disabled: 'Disabled',
        enableAll: 'All on',
        disableAll: 'All off',
        groupTag: 'Group {index}',
        missingGroupSide: 'Missing corresponding folder',
        index: 'Index',
        baseline: 'Baseline',
        comparison: 'Comparison',
        status: 'Status',
