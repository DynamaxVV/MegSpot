...
| 版本 | 日期 | 变更 |
|------|------|------|
| 2.2.12-vv1.0.2 | 2026.07.24 | 重构：新增 Worker 跳过优化、cv.Mat 懒创建、keep-alive 生命周期、WASM 瓶颈分析、完整泄漏修复清单 |
| 2.2.12-vv1.0.2 | 2026.07.24 | 初版：LRU 缓存、预加载池、Canvas/ImageBitmap/Blob URL 清理 |
